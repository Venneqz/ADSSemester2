...
public class VerketteteListenMitUpdateEmail {
    ...
    public void userInterface() {
        ...
        while (true) {
            ...
            VerketteteListenMitUpdateEmail liste = new VerketteteListenMitUpdateEmail();
    ...
    public static void main(String[] args) {
        VerketteteListenMitUpdateEmail list = new VerketteteListenMitUpdateEmail();
        list.userInterface();
    }
}